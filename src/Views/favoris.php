...
<body>
    ...
    <main class="min-vh-100 container my-5">
        ...
        <div class="row g-3 my-2">
            <?php foreach ($getFavoris as $annonces) { ?>
                <div class="col-6 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 d-flex flex-column shadow">
                        <?php
                        if (isset($_SESSION['user'])) { ?>
                            <div class="text-end m-3 mb-4"><a href="index.php?url=favoris/add/<?= htmlspecialchars($annonces['a_id']) ?>" class="btn bg-dark"><i class="bi bi-star"></i></a></div>
